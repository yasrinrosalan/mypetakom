...
<aside class="col-md-2 sidebar border-end min-vh-100 pt-4 d-none d-md-block bg-dark text-white">
    <nav class="nav flex-column px-3">
        ...
        <a class="nav-link text-white fw-semibold mb-3" href="../module-3/student_dashboard.php">
            <i class="bi bi-speedometer2 me-2"></i>Dashboard
        </a>
        <a class="nav-link text-white ps-4 mb-1" href="../module-3/view_events.php">
            <i class="bi bi-calendar-week me-2"></i>View Events
        </a>
        <a class="nav-link text-white ps-4 mb-1" href="../module-3/my_attendance.php">
            <i class="bi bi-check-square me-2"></i>My Attendance
        </a>
        <a class="nav-link text-white ps-4 mb-2" href="../module-3/claim_merit.php">
